...
This repository is intended to host **stable, implementer-focused** profiles, taxonomies and supporting artifacts that enable consistent interchange and validation of CBOM data.
...
- **Version** you are referencing (e.g., v1.0)
...
- **Standards alignment** (e.g. 3GPP spec + section if available)
